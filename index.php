  ...
  <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
          ...
          <div class="navbar-header page-scroll">
              ...
              <a class="navbar-brand" href="index.php"><span class="strong-title"><i class="fa fa-twitter-square"></i> talktalkSNS</span></a>
          </div>
      ...
      <form method="get" action="" class="form-horizontal" role="form">
        ...
        <div class="msg">
          ...
          <p>
            ...
            [<a href="index.php?res=<?php echo h($tweet['tweet_id']); ?>">Return（コメントへの返信）</a>]
          </p>
          <p class="day">
